...
import { HighlightToggler } from '../tour';
  ...
  render() {
    ...
    return (
      <div className="default-header bg-light pl-2 overflow-none">
        ...
        >
          <div className="col-sm-10" style={{ height: `${this.props.desktopHeaderHeight}px` }}>
          ...
          <div className="col-sm-26 text-right" style={{ height: `${this.props.desktopHeaderHeight}px` }}>
