import { TOUR_NEXT_HIGHLIGHT } from '../../../../src/features/tour/redux/constants';

import { nextHighlight, reducer } from '../../../../src/features/tour/redux/nextHighlight';
...
describe('tour/redux/nextHighlight', () => {
  it('returns correct action by nextHighlight', () => {
    expect(nextHighlight()).toHaveProperty('type', TOUR_NEXT_HIGHLIGHT);
  });

  it('handles action type TOUR_NEXT_HIGHLIGHT with first theme', () => {
    let prevState = initialState;
    prevState.theme = 'TEST';
    prevState.current = 0;
    let state = reducer(prevState, { type: TOUR_NEXT_HIGHLIGHT });
    ...
    state = reducer(state, { type: TOUR_NEXT_HIGHLIGHT });
